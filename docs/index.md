...
hero:
  ...
  actions:
    ...
    - theme: alt
      text: .mmdx Format
      link: /reference/mmdx-format

features:
  - title: Parameterized Templates
    details: Define configurable parameters with types, labels, and defaults. Toggle features on/off and change labels without editing diagram code.
  - title: Live Preview
